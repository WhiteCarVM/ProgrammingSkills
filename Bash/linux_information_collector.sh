...
echo "8."
echo "9."
echo "10. Доступные уязвимости: уязвимости, которые могут помочь повысить привилегии"
echo -e "\n  Замечания:"
...
# Часть 10: Доступные уязвимости (например, используя `lynis` или `rkhunter`)
echo -e "\nЧасть 10: Доступные уязвимости"
if command -v lynis &> /dev/null; then
  echo "Запуск Lynis для проверки уязвимостей..."
  lynis audit system
else
  echo "Lynis не установлен, рассмотрите возможность установки для проверки уязвимостей."
fi
