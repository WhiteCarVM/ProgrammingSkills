...
Данное приложение требует прав суперпользователя для захвата пакетов. При необходимости запустите скрипт с помощью sudo, чтобы избежать ошибок при 
попытке захвата сетевого трафика.
